    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between sm:gap-4">
        <div>
          ...
          <p className="mt-1 text-slate-500">Manage the learner accounts you have created.</p>
        </div>
        <button
          type="button"
          id="add-learner-btn"
      ...
      {isLoading ? (
        ...
        <p className="rounded-2xl border border-dashed border-blue-100 bg-white p-8 text-center text-slate-500 sm:p-10">
          No learners yet. Click <strong>Add Learner</strong> to create one.
        </p>
      ) : (
        <>
          {/* Mobile cards */}
...
function LearnerLink({
  ...
  return (
    <Link
      href={`/${tenantSlug}/${userName}/members/${learner.username}`}
